...
customerManagementApp.controller('customerAppController', function($rootScope,$scope){
    ...
    var customerDetails = {'id': id,'Name': $scope.customer.Name, 'Location': $scope.customer.Location, 'orders': $scope.customer.orders, 'image':$scope.customer.image}
...
// Update the customer 
    $scope.saveCustomer = function (customer) {
		...
		$scope.customers[idx] = angular.copy(customer);
		$scope.reset();
    };
